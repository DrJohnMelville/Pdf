...
internal class SupportClass
{
	...
	[return:NotNullIfNotNull("sbyteArray")]
	...
	[return:NotNullIfNotNull("tempObjectArray")]
	...
	{
		FacilityManager.getMsgLogger().printmsg(MsgLogger_Fields.ERROR, throwable.StackTrace??"<No Stack Trace>");
	}
