...
namespace Melville.CSJ2K.j2k.entropy
{
	...
	public struct StdEntropyCoderOptions{
		...
		{
			FIRST_BYPASS_PASS_IDX = Melville.CSJ2K.j2k.entropy.StdEntropyCoderOptions.NUM_PASSES * CSJ2K.j2k.entropy.StdEntropyCoderOptions.NUM_NON_BYPASS_MS_BP - CSJ2K.j2k.entropy.StdEntropyCoderOptions.NUM_EMPTY_PASSES_IN_MS_BP;
		}
	}
}