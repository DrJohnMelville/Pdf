...
namespace Melville.Pdf.LowLevel.Writers.DocumentWriters
{
    public static class HeaderWriter
    {
        ...
        private static readonly byte[] header = 
            {37, 80, 68, 70, 45, 49, 46, 55, 13, 10, 37, 255, 255, 255, 255, 32, 67, 114, 101, 97, 116, 101, 100, 32, 119, 105, 116, 104, 32, 77, 101, 108, 118, 105, 108, 108, 101, 46, 80, 100, 102, 13, 10};
