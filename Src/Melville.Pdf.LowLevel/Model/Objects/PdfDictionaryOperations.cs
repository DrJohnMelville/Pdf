...
public static class PdfDictionaryOperations
{
    ...
    {
        if (source.TryGetValue(key, out var obj) && await obj.ConfigureAwait(false) is T ret) return ret;
