...
public class TextRegionHuffmanFlagsTest
{
    ...
    public void HuffFSTest(ushort value, HuffmanTableSelection result) =>
    ...
    public void HuffDSTest(ushort value, HuffmanTableSelection result) =>
    ...
    public void HuffDtTest(ushort value, HuffmanTableSelection result) =>
    ...
    public void HuffRDWTest(ushort value, HuffmanTableSelection result) =>
    ...
    public void HuffRDHTest(ushort value, HuffmanTableSelection result) =>
    ...
    public void HuffRDXTest(ushort value, HuffmanTableSelection result) =>
    ...
    public void HuffRDYTest(ushort value, HuffmanTableSelection result) =>
    ...
    public void HuffRSizeText(ushort value, HuffmanTableSelection result) =>
