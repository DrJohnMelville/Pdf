...
public class WindowsDefaultFonts: IDefaultFontMapper
{
    public IFontMapping MapDefaultFont(string name) =>
        name switch
        {
            "Courier" => new NamedDefaultMapping("Courier New"),
            "Helvetica" => new NamedDefaultMapping("Arial"),
            "Times" => new NamedDefaultMapping("Times New Roman"),
            "Symbol" => new NamedDefaultMapping("Symbol"),
            "ZapfDingbats" => new DingbatsToSegoeUi(),
            _ => new NamedDefaultMapping(name)
        };
}
