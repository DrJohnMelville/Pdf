...
namespace Melville.CSJ2K
{
    ...
    using Melville.CSJ2K.j2k.codestream.writer;
    ...
    using Melville.CSJ2K.j2k.fileformat.reader;
    using Melville.CSJ2K.j2k.fileformat.writer;
    using Melville.CSJ2K.j2k.image;
    using Melville.CSJ2K.j2k.image.forwcomptransf;
    ...
    public static class J2kReader
    {
        public static PortableImage FromStream(Stream stream) => J2kImage.FromStream(stream);
    }
