...
namespace Melville.CSJ2K.j2k.codestream.reader
{
	...
	internal abstract class BitstreamReaderAgent : CodedCBlkDataSrcDec
	{
		...
		public static BitstreamReaderAgent createInstance(RandomAccessIO in_Renamed, HeaderDecoder hd, ParameterList pl, DecoderSpecs decSpec, bool cdstrInfo, HeaderInfo hi)
		{
			...
			// Check parameters
			pl.checkList(BitstreamReaderAgent.OPT_PREFIX, Melville.CSJ2K.j2k.util.ParameterList.toNameArray(BitstreamReaderAgent.ParameterInfo));
		...
		public abstract Melville.CSJ2K.j2k.entropy.decoder.DecLyrdCBlk getCodeBlock(int param1, int param2, int param3, Melville.CSJ2K.j2k.wavelet.synthesis.SubbandSyn param4, int param5, int param6, Melville.CSJ2K.j2k.entropy.decoder.DecLyrdCBlk param7);
	}
}