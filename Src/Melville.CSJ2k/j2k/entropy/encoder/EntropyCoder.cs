...
namespace Melville.CSJ2K.j2k.entropy.encoder
{
	...
	public abstract class EntropyCoder:ImgDataAdapter, CodedCBlkDataSrcEnc
	{
		...
		public abstract Melville.CSJ2K.j2k.entropy.encoder.CBlkRateDistStats getNextCodeBlock(int param1, Melville.CSJ2K.j2k.entropy.encoder.CBlkRateDistStats param2);
